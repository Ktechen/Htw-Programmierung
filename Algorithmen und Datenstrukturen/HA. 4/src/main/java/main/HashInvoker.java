...
public class HashInvoker {
	...
	public static ADSHashTable table = new ADSHashTable(size, new Hash(size), new DoubleHashing(m2));
	...
	private static final String sMsgGetIndexOfValue = "Index of Value is %d";
	...
	static public void getIndexOfValue(HashArray array, int value) {
		print(String.format(sMsgGetIndexOfValue, array.getIndexOfValue(value)));
	}
