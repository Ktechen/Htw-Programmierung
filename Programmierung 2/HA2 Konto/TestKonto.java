...
public class TestKonto {
	...
	/*
	 * @Test public void TestEinzahlenZero() { konto = new Konto();
	...
	@Test
	public void TestAbhebenMaxBlock() {
		konto = new Konto();
		konto.einzahlen(money);
		
		double currentMoney = konto.getMoney();
		
		konto.abheben(10000);
		assertTrue(konto.getMoney() == currentMoney);
