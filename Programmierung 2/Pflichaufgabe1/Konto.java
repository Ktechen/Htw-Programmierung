...
public class Konto {
	...
	private final int MIN_TRANSFER_MONEY = 0;
	...
	*/
	 ...
	 * Geld abheben
	 */
	public void abheben(double transfer) throws IllegalArgumentException{
		...
		if (transfer > MIN_TRANSFER_MONEY && transfer <= MAX_TRANSFER_MONEY) {
			...
			if (transfer >= this.money) {
				if (dispo) {
					...
					throw new IllegalArgumentException("Sie haben kein Dispo");
				}
			}
